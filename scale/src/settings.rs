...
pub const OTA_PATH: &str = "/yanshay/spoolease-bin/refs/heads/main/bins/scale/ota/";
pub const OTA_TOML_FILENAME: &str = "ota.toml";
pub const OTA_CERTS: &str = concat!(include_str!("./certs/raw.githubusercontent.com.pem"), "\0");
...
pub const WEB_SERVER_TLS_CERTIFICATE: &str =
    concat!(include_str!("./certs/web-server-certificate.pem"), "\0");
pub const WEB_SERVER_TLS_PRIVATE_KEY: &str =
    concat!(include_str!("./certs/web-server-private-key.pem"), "\0");

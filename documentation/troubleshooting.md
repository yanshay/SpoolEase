...
- Inspect the soldering, verifying both the correctness of wire connections and the quality of the soldering. Look for solder bridges or other issues - see [Issue #13](https://github.com/yanshay/SpoolEase/issues/13) for some more details.

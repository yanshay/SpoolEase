...
path_in_base_target="/bins/experiments"
page="debug.html"
rel_train="debug"
...
pushd ${xtask_dir} 
cargo xtask ota build --subtarget jc8048w550c --input "${proj_dir}" --output "$base_target_dir${path_in_base_target}/${product}/${rel_train}"
cargo xtask web-install build --subtarget jc8048w550c --input "$proj_dir" --output "$base_target_dir${path_in_base_target}/${product}/${rel_train}"
popd

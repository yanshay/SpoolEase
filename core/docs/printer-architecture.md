...
1. [partial] Continue Slint dynamic slot group rendering from backend snapshots; non-Bambu assign/set-spool-id/reset/untag exists, but Bambu generic rendering and scrolling/pagination are not done.
